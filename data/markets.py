...
SAUDI_SECTORS = {
    ...
    **{t: "الطاقة" for t in [
        ...
        # الشركات القديمة المحتفظ بها
        "2030.SR", "2080.SR", "2223.SR", "2380.SR",
    ]},
    # ══════════════════════════════════════════════════════════
    ...
    **{t: "المواد الأساسية" for t in [
        ...
        "3004.SR",  # أسمنت الشمالية
        "3005.SR",  # أسمنت أم القرى
        # محتفظ بها من التصنيف القديم
        "1202.SR", "1210.SR", "1304.SR", "1320.SR", "1321.SR",
        "2001.SR", "2090.SR", "2200.SR", "2220.SR", "2250.SR",
        "2300.SR", "3008.SR", "3080.SR", "3091.SR",
        "4143.SR", "4148.SR",
    ]},
    # ══════════════════════════════════════════════════════════
    ...
    **{t: "القطاع الصناعي" for t in [
        ...
        "2320.SR",  # البابطين للطاقة
        "4142.SR",  # كابلات الرياض
        "2110.SR",  # الكابلات السعودية
        # محتفظ بها من السلع الرأسمالية
        "1212.SR", "1214.SR", "1301.SR",
        "2040.SR", "2084.SR", "2120.SR", "2160.SR",
        "2360.SR", "2370.SR",
        "4051.SR", "4080.SR", "4110.SR", "4130.SR", "4140.SR", "4141.SR",
        "4144.SR", "4145.SR", "4146.SR", "4147.SR", "4194.SR",
        "4262.SR", "4265.SR", "4280.SR",
    ]},
    # ══════════════════════════════════════════════════════════
    ...
    **{t: "الخدمات التجارية" for t in [
        ...
        "6004.SR",  # التموين
        # محتفظ بها
        "1833.SR", "1834.SR", "1835.SR", "4270.SR",
    ]},
    # ══════════════════════════════════════════════════════════
    ...
    **{t: "الإعلام والترفيه" for t in [
    ...
    # ══════════════════════════════════════════════════════════
    **{t: "التجزئة" for t in [
        "4006.SR", "4008.SR", "4165.SR", "4191.SR", "6017.SR",
    ]},
    # ══════════════════════════════════════════════════════════
    # التعليم
    # ══════════════════════════════════════════════════════════
