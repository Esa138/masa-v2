        ...
        if not _scan_rows:
            ...
            if _purple_rows_full:
                ...
                with st.expander("🎓 شرح عمود **التوصية** — اضغط للتوسيع"):
                    st.markdown("""
| التوصية | المعنى | ماذا تفعل |
|---|---|---|
| 🟢🟢 **شراء قوي** | دعم بنفسجي + تجميع + مشترين | ⭐ ادخل — أعلى احتمال نجاح |
| 🟢 شراء — تجميع | دعم + مرحلة تجميع | ادخل بحذر مع وقف خسارة |
| 🟡 شراء — مشترين | دعم + ضغط شراء | حجم أصغر |
| 🟡 محتمل — تأكد | دعم لكن **لا بيانات Order Flow** | شغّل Order Flow أولاً |
| 🔴 حذر — تصريف عند دعم | دعم لكن المرحلة تصريف | ⛔ لا تشتري — فخ محتمل |
| 🔴🔴 بيع قوي | مقاومة + تصريف + بائعين | بيع/تجنّب |
| 🔴 بيع — تصريف | مقاومة + تصريف | بيع |
| 🟡 احتمال اختراق صاعد | مقاومة لكن تجميع | راقب الاختراق |
| ⚠️ مقاومة — راقب | مقاومة بدون إشارة | راقب فقط |
| ⚠️ كسر/اختراق — تأكد | السعر كسر/اخترق المنطقة | انتظر التأكيد |
| 👁️ يقترب — راقب | قريب لكن لم يلمس | راقب، ليس وقتها |
""")
